...
const ConnectPanel = () => (
  <Reveal>
    <div className="connect">
      ...
      <p>
        For engineering projects, robotics collaborations, or internship opportunities or just to talk
        about drones, mechatronics, or building things from scratch — I'd love to hear from you.
      </p>
      <div className="cta-row">
...
export function Home() {
  usePageMeta(
    `${SITE} | Aspiring Robotics & Drone Engineer • National Footballer • FRC Rookie All-Star`,
  ...
  return (
    <>
      ...
      <section className="section">
        <SectionHead title="Work Experience" eyebrow="Career Journey" />
      ...
      <section className="section">
        <SectionHead title="Community & Leadership" eyebrow="Impact Through Service" />
        <Reveal>
...
export function About() {
  ...
  return (
    <section className="section">
      <PageHead title="About" eyebrow="Aspiring Robotics Engineer" />
      ...
      <SubHead title="Education" eyebrow="Noida, India" />
      <div className="stack">
        {EDUCATION.map((e, i) => (
      ...
      <SubHead title="Academic Honours" />
      <div className="stack">
        {TEST_SCORES.map((s, i) => (
...
export function Work() {
  usePageMeta(`Work Experience | ${SITE}`, "Work experience and professional roles.");
  return (
    <section className="section">
      <PageHead title="Work Experience" eyebrow="Career Journey" />
      <div className="grid-2">
        {EXPERIENCE.map((e, i) => (
...
export function Projects() {
  ...
  return (
    <section className="section">
      <PageHead title="Featured Projects" eyebrow="IWhat I've Created" />
      <div className="grid-2">
        {PROJECTS.map((p, i) => (
...
export function Volunteering() {
  ...
  return (
    <section className="section">
      <PageHead title="Community & Leadership" eyebrow="Impact through Service" />
      <Reveal>
        <div className="vol-panel">
          <div className="vol-stats">
            {VOLUNTEER.stats.map((s) => (
